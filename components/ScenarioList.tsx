...
export const ScenarioList: React.FC<ScenarioListProps> = ({
  ...
  const isCompleted = (scenarioId: string) => completedScenarios.includes(scenarioId);
          ...
          <View style={styles.header}>
            ...
            <View style={styles.statsContainer}>
              <View style={styles.statItem}>
                ...
                <Text style={styles.statValue}>{completedScenarios.length}</Text>
          ...
          <View style={styles.scenariosContainer}>
            ...
            {filteredScenarios.map((scenario) => {
              ...
              return (
                <TouchableOpacity
                  key={scenario.id}
                  style={[styles.scenarioCard, completed && styles.completedCard]}
                  ...
                  <View style={styles.scenarioHeader}>
                    <View style={styles.scenarioLeft}>
                      <View style={[
                        ...
                        <CategoryIcon size={24} color={getDifficultyColor(scenario.difficulty)} />
                      </View>
                  ...
                  <View style={styles.scenarioMeta}>
                    ...
                    {scenario.timeLimit && (
                      <View style={styles.metaItem}>
                        ...
                        <Text style={styles.metaText}>{scenario.timeLimit}s</Text>
                      </View>
                    )}
