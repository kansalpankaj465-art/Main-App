...
const styles = StyleSheet.create({
  ...
  progressText: { fontSize: 16, color: PSBColors.primary.green, fontWeight: "600" },
  progressPercentage: { fontSize: 16, color: PSBColors.primary.gold, fontWeight: "bold" },
  progressBar: {
    height: 8,
  ...
  progressLabel: { fontSize: 14, color: PSBColors.text.secondary, textAlign: "center" },
  statsGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    justifyContent: "space-between",
